...
class Genealogy_Parser {
     ...
     */
     function _parseHeader() {
        ...
        $this->GedcomHeaderTreeObject =& new Genealogy_Header($Genealogy_Header_Param);
    ...
    function _parseIndividuals() {
        for ($i=0; $i < count($this->_GedcomIndividualsTree); $i++) {
            ...
            $this->GedcomIndividualsTreeObjects[] =& new Genealogy_Individual($Genealogy_Individual_Param);
        }
